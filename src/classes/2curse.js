...
If you're completely unable to orgasm due to the effects of Pleasure Respecification Curses, this will instead turn you to stone for a random 2 hour, non-sleeping period each day.`;
	static descriptionMitigated = `Thanks to the effects of the Shifting Obelisk, instead of being turned to stone you'll suffer sleep paralysis, which leaves you unable to move your body. Additional orgasms experienced while paralysed do not increase the timer.`;
